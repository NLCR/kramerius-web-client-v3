...
export const loadPeriodicalItemsSuccess = createAction('[Periodical] Load Items Success', props<{ parentVolumeUuid: string; children: any[]; availableYears?: PeriodicalItemYear[]; availableYearsRootPid?: string | null }>());
